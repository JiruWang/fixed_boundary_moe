...
class RandMixtralConfig(PreTrainedConfig):
    r"""
    ...
    def __init__(
        ...
        expert_memory_rank: int = 16,
        memory_routing_alpha: float = 0.3,
        memory_align_loss_coef: float = 0.01,
        ...
        **kwargs,
        ...
        self.flow_loss_coef = 1
        self.flow_detach_hidden = False
        self.max_flow_tokens = 2048
        self.expert_memory_rank = expert_memory_rank
        self.memory_routing_alpha = memory_routing_alpha
        self.memory_align_loss_coef = memory_align_loss_coef
        self.memory_update_interval = memory_update_interval

        super().__init__(**kwargs)


__all__ = ["RandMixtralConfig"]
